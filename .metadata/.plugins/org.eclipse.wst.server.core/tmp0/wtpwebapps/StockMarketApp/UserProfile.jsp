			...
			<div class="row" style="height: 100%">
				<div class="cell size-x200" id="cell-sidebar"
					...
					<ul class="sidebar">
						...
						<li><a href="dashboard.jsp"> <span class="title">Sell</span>
						</a></li>
					</ul>
				</div>
				<div class="cell auto-size padding20 bg-white" id="cell-content">
					...
					<form method="post" action="updateProfile">
						<%ResultSet rs=DatabaseCon.retrieveUserProfile((Integer)config.getServletContext().getAttribute("USER_ID"));
                          rs.next();
						...
						<table class="table border">
								...
								<td class="no-padding" style="padding-left: 5px !important;">
									<div class="input-control modern text iconic" data-role="input">
										<input type="text" style="padding-right: 15px;" name="name"
											value="<%=rs.getString("Name")%>"> <span class="label">Name</span>
										<span class="informer">Please enter your name</span> <span
											class="placeholder" style="display: block;">Name</span> <span
							...
							<tr>
								<td class="no-padding" style="padding-left: 5px !important;">
									<div class="input-control modern text iconic" data-role="input">
										<input type="text" style="padding-right: 5px;" name="email" value="<%=rs.getString("Email")%>">
										<span class="label">Email</span> <span class="informer">Please
							...
							<tr>
								<td><label class="label"
									...
									class="input-control radio small-check"> <input
										type="radio" id="gender_radio" name="gender_male" checked>
										<span class="check"></span> <span class="caption">Male</span>
								</label> <label class="input-control radio small-check"> <input
										type="radio" id="gender_radio" name="gender_female"> <span
										class="check"></span> <span class="caption">Female</span>
								</label></td>
							...
							<tr>
								<td colspan="2"><label class="label"
